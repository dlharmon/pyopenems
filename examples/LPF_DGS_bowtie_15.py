...
em = openems.OpenEMS('LPF_DGS_bowtie_15', EndCriteria = 1e-6, fmin = 0e6, fmax = 50e9, fsteps = 1601)
em.resolution = [25e-6, 25e-6, 500e-6]
...
openems.LPF_DGS_bowtie.generate(
    ...
    min_width = 152e-6,
    cutout_width = 1.0e-3,
    inductors = 0.15e-3 + 0.8*np.array([1.7e-3, 1.96e-3, 2e-3]),
    capacitors = np.array([0.47e-3, 0.77e-3, 0.81e-3, 0.82e-3]),
    z = z,
    port_length = 75e-6,
    ms_width = 195e-6,
    box_width = 2e-3)
